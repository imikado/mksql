<?php
class model_requete extends abstract_model{
	
	protected $sClassRow='row_requete';
	
	protected $sTable='requete';
	...
	public function findLast($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' ORDER BY id');
	}
...
class row_requete extends abstract_row{
	
	protected $sClassModel='model_requete';
