<?php
class model_bdd extends abstract_model{
	
	protected $sClassRow='row_bdd';
	
	protected $sTable='article';
	protected $sConfig='profil';
	//protected $sConfig='pdoOracleExple';
...
class row_bdd extends abstract_row{
	
	protected $sClassModel='model_bdd';
