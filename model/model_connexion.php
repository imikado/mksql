<?php
class model_connexion extends abstract_model{
	
	protected $sClassRow='row_connexion';
	
	protected $sTable='connexion';
...
class row_connexion extends abstract_row{
	
	protected $sClassModel='model_connexion';
	
	public function findTypeSgbd(){
		return model_type::getInstance()->findById($this->type);
	}
	/*exemple jointure 
